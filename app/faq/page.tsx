...
const FAQS: { category: Exclude<FaqCategory,'all'>; q: string; a: string }[] = [
  { category: 'general', q: 'What is GarageAZ?', a: 'GarageAZ is a 3D car customization platform that lets you choose a car, load its detailed 3D CAD schematic, apply upgrades like custom paint, alloys, trunk subwoofers, and interiors, and schedule an appointment with local garages to discuss implementation details.' },
  { category: 'general', q: 'Is there a cost to use the 3D configurator?', a: 'No. GarageAZ and its WebGL 3D customization suite are completely free to use. Scheduling garage appointments is also free of charge.' },
  ...
  { category: 'configurator', q: 'How does the 3D CAD visualizer work?', a: 'Select a car model from our catalog, click "Open 3D CAD", and choose a variant. Our system loads the 3D mesh. You can then rotate it 360 degrees, toggle between Exterior and 360 degree Interior cabin views, or active the CAD Wireframe mode.' },
  { category: 'configurator', q: 'What customizations can I apply in 3D?', a: 'You can customize paint colors (using preselected swatches or a custom color picker), choose between alloy wheel styles (Chrome Spoke, Matte Black Star, Golden Mesh, Sport Red Line), fit trunk subwoofers (JBL, Sony, Bass King), and adjust cabin seat materials.' },
  ...
  return (
    <div style={{ padding: '60px 24px 100px', maxWidth: '860px', margin: '0 auto' }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: '52px' }}>
        <span className="badge" style={{ marginBottom: '16px', display: 'inline-block' }}>SUPPORT</span>
